...
export const APIS = [AdminRolesService, AdminUsersService, EquipmentService, InventoryService, ItemsService, MaterialRequestsService, PurchaseReceiptsService, SalesControllerService, SuppliersService, TransferBatchesService, UserService, WarehousesService];
